...
// Khai báo extern để main.c có thể sử dụng driver instance từ Driver_GPIO.c
extern ARM_DRIVER_GPIO Driver_GPIO0;

// Các Macro hỗ trợ ánh xạ Port/Pin sang ID số nguyên (Format: PortIndex * 32 + PinIndex)
// Ví dụ sử dụng: Driver_GPIO0.Setup(ARM_GPIO_PORTC(12), NULL);

#define ARM_GPIO_PORTA(pin)     ((0U << 5) | ((pin) & 0x1FU))
#define ARM_GPIO_PORTB(pin)     ((1U << 5) | ((pin) & 0x1FU))
#define ARM_GPIO_PORTC(pin)     ((2U << 5) | ((pin) & 0x1FU))
#define ARM_GPIO_PORTD(pin)     ((3U << 5) | ((pin) & 0x1FU))
#define ARM_GPIO_PORTE(pin)     ((4U << 5) | ((pin) & 0x1FU))
